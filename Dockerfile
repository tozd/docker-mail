...
RUN apt-get update -q -q && \
 apt-get install adduser openssh-client postfix-pgsql postfix-doc amavisd-new altermime apt-listchanges arj \
  cabextract clamav-daemon cpio lhasa libmail-dkim-perl libdbd-pg-perl lzop nomarch p7zip ripole rpm \
